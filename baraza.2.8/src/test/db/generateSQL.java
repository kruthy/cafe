    ...
    public void generate() {    	 
		...
		try{
    	    ...
    	    while(rs.next()) {
				...
				String fieldCons = "";				
				System.out.println("CREATE FOREIGN TABLE i_" + table_name + " (");
				...
				for(int i = 1; i <= numberOfCols; i++) {
					...
					if(rsmd.getColumnType(i) == 1) column_type = "char(" + rsmd.getColumnDisplaySize(i) + ")";
					...
					//System.out.println("Type : " + rsmd.getColumnType(i) + " : " + rsmd.getColumnDisplaySize(i));
				...
				//System.out.println(");\n");
				System.out.println(")\nSERVER mysql_server OPTIONS(dbname 'faidaplus', table_name '" + table_name + "');");
				System.out.println("\n" + inStr + ")");
