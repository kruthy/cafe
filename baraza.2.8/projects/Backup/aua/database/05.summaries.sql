...
CREATE OR REPLACE VIEW vw_full_summary AS
...
CREATE OR REPLACE VIEW vw_session_level_stats AS
...
CREATE OR REPLACE VIEW vw_session_major_stats AS
...
CREATE OR REPLACE VIEW vw_student_year_lists AS
...
CREATE OR REPLACE VIEW vw_honors_lists AS
...
CREATE OR REPLACE VIEW vw_honors AS
	SELECT student_id, student_name, Sex, Nationality, marital_status, birth_date, student_degree_id, degree_id, sub_level_id,
		academic_year, sessionsdone, sstudent1, sstudent2, sstudent3, sstudent4,
