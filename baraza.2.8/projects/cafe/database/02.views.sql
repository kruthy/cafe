...
SELECT employees.employee_id, employees.org_id, employees.employee_name, employees.employee_gender,
   ...
   employees.work_type_id, employees.employee_user_name, employees.employee_password, employees.employee_start_date,
   employees.employee_end_date, worktype.work_type_name
FROM employees
...
SELECT orderfood.order_id, orderfood.org_id, orderfood.customer_id, orderfood.menu_id, orderfood.order_type_id, 
       ...
       customers.phone_no, ordertype.order_type_name
FROM orderfood  
...
SELECT cart.cart_id, cart.org_id, cart.customer_id, cart.order_id, cart.order_type_id, cart.food_id, cart.menu_id, cart.check_out, 
        customers.customer_name, customers.phone_no, food.food_name, ordertype.order_type_name, menus.price, employees.employee_name
FROM cart
